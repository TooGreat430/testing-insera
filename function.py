...
def _split_pdf_by_invoice_no(local_pdf_path: str, doc_type: str, vendor_id: str = "default"):
    ...
    # =========================================================================
    # [NEW] BYPASS TRACE KHUSUS SHIMANO
    # Mencegah Gemini "kelelahan" (Lost in the Middle) membaca puluhan halaman
    # sekaligus untuk format Shimano yang unik dan panjang.
    # =========================================================================
