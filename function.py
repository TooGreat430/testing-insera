...
def _kunshan_landon_realign_descriptions(rows: list, vendor_id: str):
    ...
    khusus vendor kunshan_landon. Dipanggil SETELAH PO matching (po_text
    ...
    if total_changed:
        print(f"[KUNSHAN_LANDON_DESC_REALIGN] realigned {total_changed} description cell(s)")
...
def run_ocr(
    ...
    try:
        ...
        # KUNSHAN_LANDON: setelah po_text terisi (anchor by Material code),
        # selaraskan ulang inv_description / pl_description ke baris yang benar.
        # Murni post-processing teks deskripsi; tidak menyentuh nw/gw/volume.
