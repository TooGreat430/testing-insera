...
12. pl_volume:
   ...
   - Apabila pada field pl_volume ini terdapat dua nilai speerti:
    ...
    Selalu ambil nilai volume total untuk setiap line item, bukan volume per package. Jika hanya tersedia volume per package, maka kalikan dengan jumlah package untuk mendapatkan total volume line item HANYA UNTUK ITEM ITU SAJA.
   - Apabila pada field pl_volume ini terdapat dua item yang harus dijumlahkan seperti:
      package_count    NAMA BARANG     pl_volume
            10           1-7 A          0.5
                                        10
            ...
            5              8B           0.3
                                        1.5
    Maka pahami bahwa nilai 10 adalah volume total untuk 1-7 A, dan nilai 1.5 adalah volume total untuk 8B. Sehingga volume line item untuk 1-7 A adalah 0.5 × 10 = 5, dan volume line item untuk 8B adalah 0.3 × 5 = 1.5.
