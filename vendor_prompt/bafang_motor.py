...
1. bl_description:
   ...
   - Jika tidak ada item yang ditemukan, isi null.

2. bl_hs_code:
   - Ekstrak HS code yang menempel pada bl_description yang sama.
   - Ambil value setelah "HS NUMBER:".
   - Contoh: "8714.91"
   - Hanya boleh mengambil dari dokumen Bill Of Lading (BL).
"""

BAFANG_MOTOR_COO_PROMPT = """
CERTIFICATE OF ORIGIN (COO)
