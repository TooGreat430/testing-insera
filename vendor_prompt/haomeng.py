...
1. bl_description
   ...
   - Contoh:
     - "CHAINWHEEL AND CRANK TA-CQ68"
     - "CHAINWHEEL AND CRANK TB-CY01"
   - Jangan menambah detail dari dokumen lain.
   - Jangan ambil container info, vessel, freight terms, package total, atau mark shipment.
...
10. coo_amount
   - Ambil nilai amount / FOB / value HANYA jika benar-benar tercantum pada kolom 12.
   - Jika kolom 12 hanya berisi quantity dan G.W. tanpa value/FOB, maka coo_amount = null.
   - Jangan ambil amount dari dokumen lain untuk mengisi coo_amount.
   - Jangan menebak.
...
12. coo_customer_po_no
   - Field ini hanya diisi jika ada Customer PO Number yang jelas tercetak pada COO.
   - Vendor pada dokumen ini adalah HAOMENG BICYCLE (SHANGHAI) CO., LTD.
   - Jika tidak ada customer PO number yang jelas pada COO:
     coo_customer_po_no = "null"
"""
